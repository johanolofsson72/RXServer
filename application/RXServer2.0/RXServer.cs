...
namespace RXServer
{
    ...
    public static class Data
    {
        ...
        public const String CACHEITEM_USER_COLLECTION = "RXServer::UserCollection";
        public const String CACHEITEM_USER_ID = "RXServer::UserId";
        public const String CACHEITEM_USER_ALIAS = "RXServer::UserAlias";
        public const String CACHEITEM_USER_ROLES = "RXServer::UserRoles";
        public const String CACHEITEM_USER_GROUPS = "RXServer::UserGroups";

        public const String CACHEITEM_ROLE_COLLECTION = "RXServer::UserCollection";
        public const String CACHEITEM_ROLE_ID = "RXServer::UserId";
        public const String CACHEITEM_ROLE_ALIAS = "RXServer::UserAlias";

        public const String CACHEITEM_META_COLLECTION = "RXServer::MetaCollection";
        public const String CACHEITEM_META_ID = "RXServer::MetaId";
        public const String CACHEITEM_META_ALIAS = "RXServer::MetaAlias";

        public const String CACHEITEM_LIST_COLLECTION = "RXServer::ListCollection";
        public const String CACHEITEM_LIST_ID = "RXServer::ListId";
        public const String CACHEITEM_LIST_ALIAS = "RXServer::ListAlias";
        ...
        public static void CacheInsert(String CacheItem, DataSet ds)
        {
            ...
            {
                Error.Report(ex, FUNCTIONNAME, "CacheItem:" + CacheItem);
            }
        }
        ...
        public static void CacheInsert(String CacheItem, Int32[] val)
        {
            ...
            {
                Error.Report(ex, FUNCTIONNAME, "val:" + val.ToString() + "<br>" + "CacheItem:" + CacheItem);
            }
        }
        #endregion Public Methods
    ...
    public enum ObjectType
    {
        ...
        RXServerDefined_MenuSettings = 99,
        RXServerDefined_MenuItemSettings = 100,
        RXServerDefined_Modules_PageFlipItem = 101,
        RXServerDefined_Modules_List = 102,
        RXServerDefined_Modules_ListItem = 103,
        RXServerDefined_Modules_ListItem_Material = 104,
        RXServerDefined_Modules_ListItem_Products = 105,
        RXServerDefined_Modules_ListItem_Mail = 106,
        RXServerDefined_Modules_HtmlMail = 107,
        RXServerDefined_Modules_ListItem_Meta = 108,
        RXServerDefined_Modules_ListItem_Dropdown = 109,
        RXServerDefined_Modules_ListItem_Dropdown_Type1 = 110,
        RXServerDefined_Modules_ListItem_Dropdown_Type2 = 111,
        RXServerDefined_Modules_ListItem_Dropdown_Type3 = 112,
        RXServerDefined_Modules_ListItem_Dropdown_Type4 = 113,
        RXServerDefined_Modules_ListItem_Dropdown_Type5 = 114,
        RXServerDefined_Modules_ListItem_Dropdown_Type6 = 115,
        RXServerDefined_Modules_ListItem_Dropdown_Type7 = 116,
        RXServerDefined_Modules_ListItem_Dropdown_Type8 = 117,
        RXServerDefined_Modules_ListItem_Dropdown_Type9 = 118,
        RXServerDefined_Modules_ListItem_Contacts = 119
    }
    ...
    public class RXMenuItemEnum : IEnumerator
    {
        public RXServer.Web.Menus.MenuItem[] m_menuitem;

        // Enumerators are positioned before the first element
        // until the first MoveNext() call.
        int position = -1;

        public RXMenuItemEnum(RXServer.Web.Menus.MenuItem[] list)
        {
            m_menuitem = list;
        }
        ...
        {
            position++;
            return (position < m_menuitem.Length);
        }
    ...
    //public class RXPageFlipEnum : IEnumerator
    //{
    //    //public RXServer.Web.Modules.PageFlipItem[] m_object;

    //    //// Enumerators are positioned before the first element
    //    //// until the first MoveNext() call.
    //    //int position = -1;

    //    //public RXPageFlipEnum(RXServer.Web.Modules.PageFlipItem[] list)
    //    //{
    //    //    m_object = list;
    //    //}
    ...
    {
        static string CLASSNAME = "[Namespace::RXServer][Class::Site]";
        ...
        public void Update()
        {
            ...
            try
            {
                if (this.m_exists)
                {
                    ...
                    sSQL.Append("sit_createddate = '" + this.m_sit_createddate.ToString("yyyy'-'MM'-'dd HH':'mm':'ss") + "', ");
                    sSQL.Append("sit_createdby = '" + this.m_sit_createdby.ToString() + "', ");
                    sSQL.Append("sit_updateddate = '" + this.m_sit_updateddate.ToString("yyyy'-'MM'-'dd HH':'mm':'ss") + "', ");
    ...
    public class Page : IDisposable
    {
        ...
        private String m_pag_urlname = String.Empty;
        ...
        public PageCollection Pages
        {
            get
            {
                return new PageCollection(this.m_sit_id, this.m_pag_id, this.m_autoupdate, this.m_datasource, this.m_connectionstring);
            }
        }
        ...
        public Int32 Status
        {
            ...
            {
                this.m_sta_id = value;
                PropertyUpdate("sta_id", value, PropertyUpdateType.String, PropertyUpdateTableType.Standard);
            }
        }
        public Int32 Order
        {
        ...
        public Page(String Alias, String DataSource, String ConnectionString)
        {
            this.m_datasource = DataSource;
            this.m_connectionstring = ConnectionString;
            this.m_pag_alias = Alias;
            this.GetByAlias();
        }

        public Page(String UrlName, String DataSource, String ConnectionString, Boolean IsSpecial)
        {
            this.m_datasource = DataSource;
            this.m_connectionstring = ConnectionString;
            this.m_pag_urlname = UrlName;
            this.GetByUrlName();
        }
        ...
        public void Update()
        {
            ...
            try
            {
                if (this.m_exists)
                {
                    ...
                    sSQL.Append("pag_createddate = '" + this.m_pag_createddate.ToString("yyyy'-'MM'-'dd HH':'mm':'ss") + "', ");
                    sSQL.Append("pag_createdby = '" + this.m_pag_createdby.ToString() + "', ");
                    sSQL.Append("pag_updateddate = '" + this.m_pag_updateddate.ToString("yyyy'-'MM'-'dd HH':'mm':'ss") + "', ");
        ...
        private void SortAll()
        {
            ...
            try
            {
                Int32 Order = (Int32)OrderMinMax.Min;
                StringBuilder sSQL = new StringBuilder();
                sSQL.Append("SELECT * FROM pag_pages WHERE sit_id = " + this.SiteId.ToString() + " AND pag_deleted = 0 ORDER BY sit_id, sta_id, pag_parentid, pag_order");
                using (iCDataObject oDo = new iCDataObject(this.m_datasource, this.m_connectionstring, false, true, false))
                {
                    DataTable dt = oDo.GetDataTable(sSQL.ToString());
                    foreach (DataRow dr in dt.Rows)
        ...
        private void GetByAlias()
        {
            ...
            try
            {
                String CacheItem = RXServer.Data.CACHEITEM_PAGE_ALIAS + "::Alias" + m_pag_alias;
                if (HttpContext.Current != null) if (HttpContext.Current != null) dt = (DataTable)HttpContext.Current.Cache[CacheItem];
                if (dt == null)
                {
                    StringBuilder sSQL = new StringBuilder();
                    sSQL.Append("SELECT * FROM pag_pages WHERE pag_alias = '" + m_pag_alias + "'");
                    using (iCDataObject oDo = new iCDataObject(this.m_datasource, this.m_connectionstring, false, true))
                    {
                        dt = oDo.GetDataTable(sSQL.ToString());
                    }
        ...
        // denna används bara av RXServer.Web.Menus.MenuItem i syfte av RXServer.Web.UrlRewrite
        private void GetByUrlName()
        {
            string FUNCTIONNAME = CLASSNAME + "[Function::GetByUrlName]";
            DataTable dt = null;
            try
            {
                String CacheItem = RXServer.Data.CACHEITEM_PAGE_ALIAS + "::UrlName" + m_pag_urlname;
                if (HttpContext.Current != null) if (HttpContext.Current != null) dt = (DataTable)HttpContext.Current.Cache[CacheItem];
                if (dt == null)
                {
                    StringBuilder sSQL = new StringBuilder();
                    sSQL.Append("SELECT * FROM pag_pages WHERE pag_id IN (SELECT pag_id FROM obd_objectdata WHERE obd_varchar17 = '" + m_pag_urlname + "' AND obd_alias = 'ItemSettings' AND obd_deleted = 0) AND pag_deleted = 0");
                    using (iCDataObject oDo = new iCDataObject(this.m_datasource, this.m_connectionstring, false, true))
                    {
                        dt = oDo.GetDataTable(sSQL.ToString());
                    }
            ...
            try
            {
                ...
                using (ModuleCollection mc = new ModuleCollection(this.m_sit_id, this.m_pag_id, true, RXServer.Data.DataSource, RXServer.Data.ConnectionString))
                {
                    foreach (Module m in mc.Items)
                        if(this.m_pag_id.Equals(m.PagId))
                            m.Deleted = true;
                }
        ...
        public void Update()
        {
            ...
            try
            {
                if (this.m_exists)
                {
                    ...
                    sSQL.Append("tas_createddate = '" + this.m_tas_createddate.ToString("yyyy'-'MM'-'dd HH':'mm':'ss") + "', ");
                    sSQL.Append("tas_createdby = '" + this.m_tas_createdby.ToString() + "', ");
                    sSQL.Append("tas_updateddate = '" + this.m_tas_updateddate.ToString("yyyy'-'MM'-'dd HH':'mm':'ss") + "', ");
    ...
    public class ObjectCollection : IDisposable, IEnumerable
    {
        ...
        public ObjectCollection(ObjectType ObjectType, String Alias, String DataSource, String ConnectionString)
            : this(ObjectType, Alias, DataSource, ConnectionString, true)
        {
        }
        ...
        public ObjectCollection(ObjectType ObjectType, String Alias, String DataSource, String ConnectionString, Boolean Refresh)
        {
            this.m_datasource = DataSource;
            this.m_connectionstring = ConnectionString;
            this.m_obd_alias = Alias;
        ...
        /// </summary>
        /// <returns></returns>
        public DataSet GetAllForNFM()
        {
            string FUNCTIONNAME = CLASSNAME + "[Namespace::RXServer][Class::ObjectCollection][Function::GetAllForNFM]";
            DataSet ds = new DataSet();
            try
            {
                StringBuilder sSQL = new StringBuilder();
                sSQL.Append("select * from obd_objectdata where obd_alias like 'Article1ReadMore' AND obd_deleted = 0 AND mod_id IN (SELECT obd_varchar10 FROM obd_objectdata WHERE obd_alias = 'Article1' AND obd_deleted = 0) ");
                sSQL.Append("OR obd_alias like 'Article2ReadMore' AND obd_deleted = 0 AND mod_id IN (SELECT obd_varchar10 FROM obd_objectdata WHERE obd_alias = 'Article2' AND obd_deleted = 0) ");
                sSQL.Append("OR obd_alias like 'Article3ReadMore' AND obd_deleted = 0 AND mod_id IN (SELECT obd_varchar10 FROM obd_objectdata WHERE obd_alias = 'Article3' AND obd_deleted = 0) ");
                sSQL.Append("ORDER BY obd_order DESC");
                using (iCDataObject oDo = new iCDataObject(this.m_datasource, this.m_connectionstring, false, true, false))
                {
                    ds = oDo.GetDataSet(sSQL.ToString());
                }
                foreach(DataTable dt in ds.Tables)
                    foreach (DataRow dr in dt.Rows)
                    {
                        StringBuilder sSQL2 = new StringBuilder();
                        sSQL2.Append("SELECT mod_order FROM mod_modules WHERE mod_id IN (SELECT mod_id FROM obd_objectdata WHERE obd_varchar7 = '1' AND obd_varchar10 = '" + dr["mod_id"].ToString() + "')");
                        using (iCDataObject oDo = new iCDataObject(this.m_datasource, this.m_connectionstring, false, true, false))
                        {
                            String order = oDo.GetDataTable(sSQL2.ToString()).Rows[0][0].ToString();
                            dr["obd_order"] = order;
                        }
                    }
                DataView v = new DataView(ds.Tables[0]);
                v.Sort = "obd_order ASC";
                ...
                foreach (DataTable dt in ds.Tables)
                    foreach (DataRow dr in dt.Rows)
                    {
                        dr["obd_varchar50"] = ind.ToString();
                        ind++;
                    }
                v = new DataView(ds.Tables[0]);
                v.RowFilter = "obd_varchar50 < 3";
                v.Sort = "obd_order ASC";
                ds.Tables.RemoveAt(0);
                ds.Tables.Add(v.ToTable());
                return ds;
        ...
        /// <returns></returns>
        public DataSet getAllNews(String _alias, Int32 _max, String _orderBy, String _sortBy)
        {
            string FUNCTIONNAME = CLASSNAME + "[Namespace::RXServer][Class::ObjectCollection][Function::getAllNews]";
            DataSet ds = new DataSet();
            try
            {
                StringBuilder sSQL = new StringBuilder();
                sSQL.Append("SELECT * FROM obd_objectdata WHERE obd_alias like '" + _alias + "' AND obd_deleted = '0' AND mod_id IN (SELECT mod_id FROM mod_modules WHERE mod_deleted = 0) ");
                sSQL.Append("ORDER BY " + _orderBy + "  " + _sortBy + " ");
                sSQL.Append("LIMIT " + _max + " ");
                using (iCDataObject oDo = new iCDataObject(this.m_datasource, this.m_connectionstring, false, true, false))
                {
                    ds = oDo.GetDataSet(sSQL.ToString());
                    foreach (DataTable dt in ds.Tables)
                    {
                        ...
                        {
                            StringBuilder sSQL2 = new StringBuilder();
                            sSQL2.Append("SELECT mod_order FROM mod_modules WHERE mod_id IN (SELECT mod_id FROM obd_objectdata WHERE obd_varchar7 = '1' AND obd_varchar10 = '" + dr["mod_id"].ToString() + "' AND mod_deleted = '0')");
                            DataTable dt2  = oDo.GetDataTable(sSQL2.ToString());
                            String order = "0";
                            if (dt2.Rows.Count > 0)
                                order = dt2.Rows[0][0].ToString();
                            dr["obd_order"] = order;
                        }
                    }   
                }          
        ...
        private void GetAll()
        {
            ...
            try
            {
                ...
                if (dt == null)
                {
                    ...
                    else if (this.m_sit_id == 0 && this.m_pag_id == 0 && this.m_pag_id == 0 && this.m_obd_alias.Length > 0)
                        sSQL.Append("SELECT * FROM obd_objectdata WHERE obd_deleted = 0" + Convert.ToString(this.m_objecttype != ObjectType.Undefined ? " AND obd_type = " + Convert.ToString((Int32)this.m_objecttype) : String.Empty) + " AND obd_alias = '" + this.m_obd_alias.ToString() + "' ORDER BY obd_order");
                    else
    ...
    public class Object : IDisposable
    {
        ...
        public void Update()
        {
            ...
            try
            {
                if (this.m_exists)
                {
                    ...
                    sSQL.Append("obd_createddate = '" + this.m_obd_createddate.ToString("yyyy'-'MM'-'dd HH':'mm':'ss") + "', ");
                    sSQL.Append("obd_createdby = '" + this.m_obd_createdby.ToString() + "', ");
                    sSQL.Append("obd_updateddate = '" + this.m_obd_updateddate.ToString("yyyy'-'MM'-'dd HH':'mm':'ss") + "', ");
        ...
        private void ResetThis()
        {
            ...
            try
            {
                ...
                // test för vår nya webb, sedan obd items i pages inte är uppdaterade somde ska....
                //RXServer.Data.ResetCache(RXServer.Data.CACHEITEM_PAGE_ID);
                //RXServer.Data.ResetCache(RXServer.Data.CACHEITEM_PAGE_ALIAS);
                //RXServer.Data.ResetCache(RXServer.Data.CACHEITEM_PAGE_COLLECTION);
                //RXServer.Data.ResetCache(RXServer.Data.CACHEITEM_PAGE_ROLES);
        ...
        private void SortAll()
        {
            ...
            try
            {
                Int32 Order = (Int32)OrderMinMax.Min;
                StringBuilder sSQL = new StringBuilder();
                sSQL.Append("SELECT * FROM obd_objectdata WHERE obd_deleted = 0 ORDER BY sit_id, pag_id, obd_type, obd_alias, obd_order");
                using (iCDataObject oDo = new iCDataObject(this.m_datasource, this.m_connectionstring, false, true, false))
                {
                    DataTable dt = oDo.GetDataTable(sSQL.ToString());
                    foreach (DataRow dr in dt.Rows)
        ...
        private void GetById()
        {
            ...
            try
            {
                String CacheItem = RXServer.Data.CACHEITEM_OBJECT_ID + "::ObdId" + m_obd_id.ToString() + "::ObdType" + Convert.ToString((Int32)this.m_obd_type);
                if (HttpContext.Current != null) if (HttpContext.Current != null) dt = (DataTable)HttpContext.Current.Cache[CacheItem];
                if (dt == null)
                {
                    StringBuilder sSQL = new StringBuilder();
                    sSQL.Append("SELECT * FROM obd_objectdata WHERE obd_id = " + m_obd_id.ToString() + Convert.ToString(this.m_obd_type != ObjectType.Undefined ? " AND obd_type = " + Convert.ToString((Int32)this.m_obd_type) : String.Empty));
                    using (iCDataObject oDo = new iCDataObject(this.m_datasource, this.m_connectionstring, false, true))
                    {
                        dt = oDo.GetDataTable(sSQL.ToString());
                    }
        ...
        private void GetBySitId()
        {
            ...
            try
            {
                String CacheItem = RXServer.Data.CACHEITEM_OBJECT_ID + "::SitId" + m_sit_id.ToString() + "::ObdType" + Convert.ToString((Int32)this.m_obd_type);
                if (HttpContext.Current != null) if (HttpContext.Current != null) dt = (DataTable)HttpContext.Current.Cache[CacheItem];
                if (dt == null)
                {
                    StringBuilder sSQL = new StringBuilder();
                    sSQL.Append("SELECT * FROM obd_objectdata WHERE sit_id = " + m_sit_id.ToString() + Convert.ToString(this.m_obd_type != ObjectType.Undefined ? " AND obd_type = " + Convert.ToString((Int32)this.m_obd_type) : String.Empty));
                    using (iCDataObject oDo = new iCDataObject(this.m_datasource, this.m_connectionstring, false, true))
                    {
                        dt = oDo.GetDataTable(sSQL.ToString());
                    }
        ...
        private void GetBySitIdPagId()
        {
            ...
            try
            {
                String CacheItem = RXServer.Data.CACHEITEM_OBJECT_ID + "::SitId" + m_sit_id.ToString() + "::PagId" + m_pag_id.ToString() + "::ObdType" + Convert.ToString((Int32)this.m_obd_type);
                if (HttpContext.Current != null) if (HttpContext.Current != null) dt = (DataTable)HttpContext.Current.Cache[CacheItem];
                if (dt == null)
                {
                    StringBuilder sSQL = new StringBuilder();
                    sSQL.Append("SELECT * FROM obd_objectdata WHERE sit_id = " + m_sit_id.ToString() + " AND pag_id = " + m_pag_id.ToString() + Convert.ToString(this.m_obd_type != ObjectType.Undefined ? " AND obd_type = " + Convert.ToString((Int32)this.m_obd_type) : String.Empty));
                    using (iCDataObject oDo = new iCDataObject(this.m_datasource, this.m_connectionstring, false, true))
                    {
                        dt = oDo.GetDataTable(sSQL.ToString());
                    }
        ...
        private void GetBySitIdPagIdModId()
        {
            ...
            try
            {
                String CacheItem = RXServer.Data.CACHEITEM_OBJECT_ID + "::SitId" + m_sit_id.ToString() + "::PagId" + m_pag_id.ToString() + "::ModId" + m_mod_id.ToString() + "::ObdType" + Convert.ToString((Int32)this.m_obd_type);
                if (HttpContext.Current != null) if (HttpContext.Current != null) dt = (DataTable)HttpContext.Current.Cache[CacheItem];
                if (dt == null)
                {
                    StringBuilder sSQL = new StringBuilder();
                    sSQL.Append("SELECT * FROM obd_objectdata WHERE sit_id = " + m_sit_id.ToString() + " AND pag_id = " + m_pag_id.ToString() + " AND mod_id = " + m_mod_id.ToString() + Convert.ToString(this.m_obd_type != ObjectType.Undefined ? " AND obd_type = " + Convert.ToString((Int32)this.m_obd_type) : String.Empty));
                    using (iCDataObject oDo = new iCDataObject(this.m_datasource, this.m_connectionstring, false, true))
                    {
                        dt = oDo.GetDataTable(sSQL.ToString());
                    }
    ...
    public class DocumentCollection : IDisposable, IEnumerable
    {
        ...
        public DocumentCollection(ObjectType ObjectType, Int32 SitId, Int32 PagId, Int32 ModId, bool AutoUpdate, String DataSource, String ConnectionString) : this(ObjectType, SitId, PagId, ModId, AutoUpdate, DataSource, ConnectionString, true)
        {
        }
        ...
        public DocumentCollection(ObjectType ObjectType, Int32 SitId, Int32 PagId, Int32 ModId, bool AutoUpdate, String DataSource, String ConnectionString, Boolean Refresh)
        {
            this.m_datasource = DataSource;
            this.m_connectionstring = ConnectionString;
            this.m_sit_id = SitId;
        ...
        public void Add(ref Document Document)
        {
            ...
            try
            {
                DataSet ds = new DataSet();
                StringBuilder sSQL = new StringBuilder();
                sSQL.Append("INSERT INTO doc_documents (lng_id, doc_parentid, sit_id, pag_id, mod_id, doc_order, doc_type, doc_title, ");
                ...
                sSQL.Append("" + Document.ModId.ToString() + ", ");
                ...
                sSQL.Append("'" + Document.CheckOutDate.ToString("yyyy'-'MM'-'dd HH':'mm':'ss") + "', ");
                sSQL.Append("'" + Document.CheckOutExpireDate.ToString("yyyy'-'MM'-'dd HH':'mm':'ss") + "', ");
                sSQL.Append("'" + Document.LastViewedDate.ToString("yyyy'-'MM'-'dd HH':'mm':'ss") + "', ");
                ...
                sSQL.Append("'" + Document.DeliverDate.ToString("yyyy'-'MM'-'dd HH':'mm':'ss") + "', ");
        ...
        private void GetAll()
        {
            ...
            try
            {
                String CacheItem = RXServer.Data.CACHEITEM_DOCUMENT_COLLECTION + "::SitId" + this.m_sit_id.ToString() + "::PagId" + this.m_pag_id.ToString() + "::ModId" + this.m_mod_id.ToString();
                if (HttpContext.Current != null) if (HttpContext.Current != null) dt = (DataTable)HttpContext.Current.Cache[CacheItem];
                if (dt == null)
                {
                    StringBuilder sSQL = new StringBuilder();
                    if (this.m_sit_id > 0 && this.m_pag_id > 0 && this.m_mod_id > 0)
                        sSQL.Append("SELECT * FROM doc_documents WHERE doc_deleted = 0 AND sit_id = " + this.m_sit_id.ToString() + " AND pag_id = " + this.m_pag_id.ToString() + " AND mod_id = " + this.m_mod_id.ToString() + Convert.ToString(this.m_objecttype != ObjectType.Undefined ? " AND doc_type = " + Convert.ToString((Int32)this.m_objecttype) : String.Empty) + " ORDER BY doc_order");
                    else if (this.m_sit_id > 0 && this.m_pag_id > 0)
    ...
    public class Document : IDisposable
    {
        ...
        public Document(Int32 Special, ObjectType ObjectType, int SitId, int PagId, int ModId, String DataSource, String ConnectionString)
        {
            this.m_datasource = DataSource;
            this.m_connectionstring = ConnectionString;
            this.m_sit_id = SitId;
        ...
        public void Update()
        {
            ...
            try
            {
                if (this.m_exists)
                {
                    ...
                    sSQL.Append("doc_checkoutdate = '" + this.m_doc_checkoutdate.ToString("yyyy'-'MM'-'dd HH':'mm':'ss") + "', ");
                    sSQL.Append("doc_checkoutexpiredate = '" + this.m_doc_checkoutexpiredate.ToString("yyyy'-'MM'-'dd HH':'mm':'ss") + "', ");
                    sSQL.Append("doc_lastvieweddate = '" + this.m_doc_lastvieweddate.ToString("yyyy'-'MM'-'dd HH':'mm':'ss") + "', ");
                    ...
                    sSQL.Append("doc_deliverdate = '" + this.m_doc_deliverdate.ToString("yyyy'-'MM'-'dd HH':'mm':'ss") + "', ");
                    sSQL.Append("doc_deliverby = '" + this.m_doc_deliverby.ToString() + "', ");
                    sSQL.Append("doc_deliverto = '" + this.m_doc_deliverto.ToString() + "', ");

                    sSQL.Append("doc_createddate = '" + this.m_doc_createddate.ToString("yyyy'-'MM'-'dd HH':'mm':'ss") + "', ");
                    sSQL.Append("doc_createdby = '" + this.m_doc_createdby.ToString() + "', ");
                    sSQL.Append("doc_updateddate = '" + this.m_doc_updateddate.ToString("yyyy'-'MM'-'dd HH':'mm':'ss") + "', ");
        ...
        private void GetByModId()
        {
            string FUNCTIONNAME = CLASSNAME + "[Function::GetByModId]";
            DataTable dt = null;
            try
            {
                String CacheItem = RXServer.Data.CACHEITEM_DOCUMENT_ID + "::ModId" + m_mod_id.ToString();
                if (HttpContext.Current != null) if (HttpContext.Current != null) dt = (DataTable)HttpContext.Current.Cache[CacheItem];
                if (dt == null)
                {
                    StringBuilder sSQL = new StringBuilder();
                    sSQL.Append("SELECT * FROM doc_documents WHERE doc_deleted = 0 AND mod_id = " + m_mod_id.ToString());
                    using (iCDataObject oDo = new iCDataObject(this.m_datasource, this.m_connectionstring, false, true))
                    {
                        dt = oDo.GetDataTable(sSQL.ToString());
                    }
    ...
    public class ModuleCollection : IDisposable, IEnumerable
    {
        ...
        public ModuleCollection(Int32 SitId, Int32 PagId, bool AutoUpdate, Int32[] Source, String DataSource, String ConnectionString) : this(SitId, PagId, AutoUpdate, Source, DataSource, ConnectionString, true) { }
        ...
        public ModuleCollection(Int32 SitId, Int32 PagId, bool AutoUpdate, Int32[] Source, String DataSource, String ConnectionString, Boolean Refresh)
        {
            this.m_datasource = DataSource;
            this.m_connectionstring = ConnectionString;
            this.m_sit_id = SitId;
        ...
        public void Add(ref Module module)
        {
            ...
            try
            {
                ...
                sSQL.Append("mod_allpages, mod_ssl, mod_createddate, mod_createdby, mod_updateddate, mod_updatedby, ");
                ...
                sSQL.Append(Convert.ToInt32(module.SSL).ToString() + ", ");
                sSQL.Append("'" + DateTime.Now.ToString("yyyy'-'MM'-'dd HH':'mm':'ss") + "', ");
                if (HttpContext.Current != null) { sSQL.Append("'" + RXServer.Authentication.User.Identity.Name + "', "); } else { sSQL.Append("'NoIdentity', "); }
                sSQL.Append("'" + DateTime.Now.ToString("yyyy'-'MM'-'dd HH':'mm':'ss") + "', ");
                if (HttpContext.Current != null) { sSQL.Append("'" + RXServer.Authentication.User.Identity.Name + "', "); } else { sSQL.Append("'NoIdentity', "); }
        ...
        {
            string FUNCTIONNAME = CLASSNAME + "[Function::ClearSecure]";
            try
            {
                foreach (Module m in this.Items)
                {
                    if (!m.Secure)
                        Remove(m);
                }
        ...
        private void GetAll()
        {
            ...
            try
            {
                ...
                {
                    StringBuilder sSQL = new StringBuilder();
                    sSQL.Append("SELECT * FROM mod_modules WHERE sit_id = " + this.m_sit_id.ToString() + " AND pag_id = " + this.m_pag_id.ToString() + " AND mod_parentid = " + this.m_mod_parentid.ToString() + " AND mod_deleted = 0 OR sit_id = " + this.m_sit_id.ToString() + " AND mod_allpages = 1 AND mod_parentid = " + this.m_mod_parentid.ToString() + " AND mod_deleted = 0 ORDER BY mod_order");
                    using (iCDataObject oDo = new iCDataObject(this.m_datasource, this.m_connectionstring, false, true, false))
                    {
                        dt = oDo.GetDataTable(sSQL.ToString());
                    }
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow dr in dt.Rows)
                    {
                        ...
                        this.m_modules[index].AuthorizedEditRoles = this.GetAuthorizedEditRoles(Convert.ToInt32(dr["mod_id"]));
                        this.m_modules[index].AuthorizedEditGroups = this.GetAuthorizedEditGroups(Convert.ToInt32(dr["mod_id"]));
                        ...
                        this.m_modules[index].SSL = Convert.ToBoolean(dr["mod_ssl"]);
        ...
        private void GetAllBySource(Int32[] Source)
        {
            string FUNCTIONNAME = CLASSNAME + "[Function::GetAllBySource]";
            DataTable dt = null;
            try
            {
                String s = "0";
                foreach (Int32 k in Source)
                    s = s + "," + k.ToString();

                String CacheItem = RXServer.Data.CACHEITEM_MODULE_COLLECTION + "::SitId" + this.m_sit_id.ToString() + "::PagId" + this.m_pag_id.ToString() + "::ParentId" + this.m_mod_parentid.ToString() + "::GetAllBySource(" + s + ")";
                if (HttpContext.Current != null) if (HttpContext.Current != null) dt = (DataTable)HttpContext.Current.Cache[CacheItem];
                if (dt == null)
                {
                    StringBuilder sSQL = new StringBuilder();
                    sSQL.Append("SELECT * FROM mod_modules WHERE sit_id = " + this.m_sit_id.ToString() + " AND pag_id = " + this.m_pag_id.ToString() + " AND mod_parentid = " + this.m_mod_parentid.ToString() + " AND mde_id IN(" + s + ") AND mod_deleted = 0 ORDER BY mod_order");
                    using (iCDataObject oDo = new iCDataObject(this.m_datasource, this.m_connectionstring, false, true, false))
                    {
                        dt = oDo.GetDataTable(sSQL.ToString());
                    }
    ...
    public class Module : IDisposable
    {
        ...
        public bool SSL
        {
            get
            {
                return this.m_mod_ssl;
            }
            set
            {
                this.m_mod_ssl = value;
                PropertyUpdate("mod_ssl", value, PropertyUpdateType.Boolean, PropertyUpdateTableType.Standard);
            }
        }
        public DateTime CreatedDate
        {
        ...
        public Module(int SitId, int PagId, String Alias, String DataSource, String ConnectionString)
        {
            this.m_datasource = DataSource;
            this.m_connectionstring = ConnectionString;
            this.m_sit_id = SitId;
            this.m_pag_id = PagId;
            this.m_mod_alias = Alias;
            this.GetByAlias();
        }
        ...
        public void Update()
        {
            ...
            try
            {
                if (this.m_exists)
                {
                    ...
                    sSQL.Append("mod_ssl = " + Convert.ToInt32(this.m_mod_ssl).ToString() + ", ");
                    sSQL.Append("mod_createddate = '" + this.m_mod_createddate.ToString("yyyy'-'MM'-'dd HH':'mm':'ss") + "', ");
                    sSQL.Append("mod_createdby = '" + this.m_mod_createdby.ToString() + "', ");
                    sSQL.Append("mod_updateddate = '" + this.m_mod_updateddate.ToString("yyyy'-'MM'-'dd HH':'mm':'ss") + "', ");
        ...
        public virtual void Save()
        {
            ...
            try
            {
                if (!this.m_exists)
                {
                    StringBuilder sSQL = new StringBuilder();
                    sSQL.Append("INSERT INTO mod_modules (sit_id, pag_id, lng_id, mde_id, mod_parentid, mod_order, ");
                    sSQL.Append("mod_title, mod_alias, mod_description, mod_pane, mod_cachetime, mod_theme, mod_skin, mod_editsrc, mod_secure, mod_ssl, ");
                    ...
                    sSQL.Append(Convert.ToInt32(this.Secure ? 1 : 0).ToString() + ", ");
                    sSQL.Append(Convert.ToInt32(this.SSL ? 1 : 0).ToString() + ", ");
                    sSQL.Append(Convert.ToInt32(this.AllPages ? 1 : 0).ToString() + ", ");
                    sSQL.Append("'" + DateTime.Now.ToString("yyyy'-'MM'-'dd HH':'mm':'ss") + "', ");
                    if (HttpContext.Current != null) { sSQL.Append("'" + RXServer.Authentication.User.Identity.Name + "', "); } else { sSQL.Append("'NoIdentity', "); }
                    sSQL.Append("'" + DateTime.Now.ToString("yyyy'-'MM'-'dd HH':'mm':'ss") + "', ");
                    if (HttpContext.Current != null) { sSQL.Append("'" + RXServer.Authentication.User.Identity.Name + "', "); } else { sSQL.Append("'NoIdentity', "); }
        ...
        private void GetById()
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    this.m_mod_ssl = Convert.ToBoolean(dr["mod_ssl"]);
        ...
        private void GetByAlias()
        {
            ...
            try
            {
                String CacheItem = RXServer.Data.CACHEITEM_MODULE_ID + "::SitId" + m_sit_id.ToString() + "::PagId" + m_pag_id.ToString() + "::ModId" + m_mod_id.ToString() + "::ModAlias" + m_mod_alias;
                if (HttpContext.Current != null) if (HttpContext.Current != null) dt = (DataTable)HttpContext.Current.Cache[CacheItem];
                if (dt == null)
                {
                    StringBuilder sSQL = new StringBuilder();
                    sSQL.Append("SELECT * FROM mod_modules WHERE sit_id = " + SitId.ToString() + " AND pag_id = " + PagId.ToString() + " AND mod_alias = '" + m_mod_alias + "'");
                    using (iCDataObject oDo = new iCDataObject(this.m_datasource, this.m_connectionstring, false, true))
                    {
                        dt = oDo.GetDataTable(sSQL.ToString());
                    }
    ...
    public class Rss
    {
        ...
        private string _title = "LiquidCore Error Handler";
        private string _link = "http://www.iconsulting.se/rss/";
        private string _description = "Error information in rss format.";
        private string _copyright = "Copyright 2005 Johan Olofsson";
        private string _generator = "LiquidCore RssCreator 1.0";
        public Rss()
        {
    ...
    /// </summary>
    #region public class RXMasterPageVirtual
    public class RXMasterPageVirtual : System.Web.UI.MasterPage
    {
        public RXServer.Page RXPage;
        public RXServer.Web.Menus.Menu RXMenu;
        public RXServer.Web.Menus.MenuItem RXCurrentMenuItem;
        ...
        public virtual void Page_PreInit(object sender, EventArgs e)
        {
            ...
            this.Page.Title = Server.UrlDecode(RXCurrentMenuItem.Name);
            this.Page.Theme = RXCurrentMenuItem.Theme;

            //Control c = Page.FindControl("ContentTemplate");
            Control c = Common.FindControlRecursive(Page.Master, "ContentTemplate");
            c.SkinID = RXCurrentMenuItem.Skin;
        }
        ...
        public virtual void Page_Init(object sender, EventArgs e)
        {
            ...
            foreach (RXServer.Module m in this.RXCurrentMenuItem.Modules)
            {
    ...
    #endregion public class RXMasterPageVirtual
    ...
    public class RXPageVirtual : System.Web.UI.Page
    {
        ...
        public virtual void Page_PreInit(object sender, EventArgs e)
        {
            ...
            this.Theme = RXCurrentMenuItem.Theme;

    ...
    namespace Web
    {
        namespace Parse
        {
            public class Replace
            {
                        ...
                        while (!parse.Eof())
                        {
                            ...
                            if (ch == 0)
                            {
                                ...
                                if (tag["href"] != null && CheckString != null)
                                {
                                    ...
                                    System.Diagnostics.Debug.WriteLine("tag[href].Value: " + tag["href"].Value);
                                }
                                if (tag["href"] != null && UnvalidCheckString.Equals(false))
                                {
                                    if (tag["href"].Value.Contains("http://"))
                                    {
                                        ...
                                        //Orginal = Orginal.Replace(tag["href"].Value, Replacement + tag["href"].Value.Replace("http://", ""));
                ...
                public static String TruncateText(String Text, Int32 Length)
                {
                    string FUNCTIONNAME = CLASSNAME + "[Function::TruncateText]";
                    try
                    {

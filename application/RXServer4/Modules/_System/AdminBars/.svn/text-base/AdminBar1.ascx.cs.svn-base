...
public partial class Modules__System_AdminBars_AdminBar1 : RXServer.Lib.RXBaseAdminBarModule
{
    String class_name = "Modules__System_AdminBars_AdminBar1";

    protected void Page_Load(object sender, EventArgs e)
    {
        this.img_AdminEdit.OnClientClick = "javascript:showAdminBox('" + this.AdminUrl + "'," + this.SitId + "," + this.PagId + "," + this.ModId + ",'" + RXMali.GetModelId(this.SitId, this.PagId, this.ModId, this.MasterPageFile) + "'); return false;";

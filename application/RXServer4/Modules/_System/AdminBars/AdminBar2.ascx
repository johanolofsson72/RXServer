<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AdminBar2.ascx.cs" Inherits="Modules__System_AdminBars_AdminBar2" %>
...
<div id="TextBox_admin" runat="server">
        ...
        <div id="adminbar" style="position:relative; float:left; height:35px;">
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td style="font-size:1px; height:5px; text-align:center;"><asp:Image ID="Image0" runat="server" ImageUrl="~/App_Themes/WebAdmin/Images/adminbar_arrow_red.gif" /></td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td></td>

...
public partial class Modules_Search_Search_Search_Admin : RXServer.Lib.RXDefaultPage
{
    String class_name = "Modules_Search_Search_Search_Admin";
    protected void Page_Load(object sender, EventArgs e)
    {
        String function_name = "Page_Load";
        try
        {
            this.ltrHelpText.Text = RXMali.GetXMLHelpNode("Search/Text");

<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Structure/WebAdmin/WebAdmin.master" CodeFile="EditModulesXLarge_Admin.aspx.cs" Inherits="Modules_Modules_EditModules_EditModulesLarge_Admin" %>
             ...
             <tr>
                ...
                <td style="width:50px; text-align:left; vertical-align:top;">
                   ...
                   <asp:ImageButton id="ImageButton1" 
                        ImageUrl="~/Images/Modules/Icons/icon_mod_text1.gif" runat="server" 
                        onclick="imbAddModule_110_Click" />
                </td>
             ...
             <tr>
                ...
                <td style="width:180px; text-align:left; vertical-align:top;">
                  <span class='Text14_bold_gray'>
                    ...
                    <span class='Text11_bold_gray'>
                        Module showing all categories and products.
                    </span>
                </td>
                <td style="width:10px; text-align:left;"></td>
                <td style="width:50px; text-align:left;"></td>
                <td style="width:10px; text-align:left;"></td>
                <td style="width:180px; text-align:left; vertical-align:top;"></td>
                <td style="text-align:left;"></td>
            </tr>
            <tr>
                <td colspan="8" style="text-align:left; height: 20px; font-size:1px;"></td>

...
public partial class Modules_Modules_EditModules_EditModulesMedium_Admin : RXServer.Lib.RXDefaultPage
{
    ...
    protected void imbAddModule_3_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            ...
            if (PagId > 0 && ConPaId > 0)
            {
                ...
                int modId = RXServer.Modules.MediaModule.Create(1, PagId, 91, conPa, 1, 1, false, false);
				LiquidCore.Module m = new LiquidCore.Module(modId);
				m.CacheTime = 20;
				m.Save();
    ...
    protected void imbAddModule_4_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            ...
            if (PagId > 0 && ConPaId > 0)
            {
                ...
                int modId = RXServer.Modules.MediaModule.Create(1, PagId, 94, conPa, 1, 1, false, false);
				LiquidCore.Module m = new LiquidCore.Module(modId);
				m.CacheTime = 20;
				m.Save();
    ...
    protected void imbAddModule_5_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            ...
            if (PagId > 0 && ConPaId > 0)
            {
                ...
                RXServer.Modules.MediaModule.Create(1, PagId, 99, conPa, 1, 1, false, false);
    ...
    protected void imbAddModule_6_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            ...
            if (PagId > 0 && ConPaId > 0)
            {
                ...
                int modId = RXServer.Modules.StandardModule.Create(1, PagId, 32, conPa, 1, 1, false, false);
				LiquidCore.Module m = new LiquidCore.Module(modId);
				m.CacheTime = 20;
				m.Save();
    ...
    protected void imbAddModule_8_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            ...
            if (PagId > 0 && ConPaId > 0)
            {
                ...
                int modId = RXServer.Modules.StandardModule.Create(1, PagId, 90, conPa, 1, 1, false, false);
				LiquidCore.Module m = new LiquidCore.Module(modId);
				m.CacheTime = 20;
				m.Save();

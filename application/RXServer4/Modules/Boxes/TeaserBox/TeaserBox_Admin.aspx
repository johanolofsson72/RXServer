<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Structure/WebAdmin/WebAdmin.master" CodeFile="TeaserBox_Admin.aspx.cs" Inherits="Modules_Boxes_TeaserBox_TeaserBox_Admin" %>
...
<asp:Content ID="Content" ContentPlaceHolderId="MainAdminContent" runat="server">
    ...
    <div id="Page_1" runat="server" visible="false" class="Page_div">
        <span class='Text18_bold_gray'>Edit Teaser</span>
        <br />
        <hr class='line' />
        <br />        
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td class="Text12_gray">Extended:</td>
            </tr>
            <tr>
                <td>
                 <telerik:radeditor runat="server" 
        ...
        <br />
        <br />
        <span class='Text18_bold_gray'>Edit Internal Link</span>
        <br />
        <hr class='line' />
        <br />    
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td class="Text12_gray">Type:</td>
            </tr>
            <tr>
                <td class="Text12_gray"><asp:RadioButton ID="rbtnInternal" runat="server" Text="Internal" GroupName="Internal" Checked="true" />&nbsp;<asp:RadioButton ID="rbtnExtended" runat="server" Text="Extended article" GroupName="Internal" /></td>
            </tr>
            <tr>
                <td style="height:10px; font-size:1px;">&nbsp;</td>
            </tr>
        ...
        <asp:Button ID="btnSaveText" runat="server" Text="Save" 
            class="form_button" onclick="btnSaveText_Click" />
        </div>

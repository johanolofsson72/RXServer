<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Structure/WebAdmin/WebAdmin.master" CodeFile="ShopBox_Admin.aspx.cs" Inherits="Modules_Boxes_ShopBox_ShopBox_Admin" %>

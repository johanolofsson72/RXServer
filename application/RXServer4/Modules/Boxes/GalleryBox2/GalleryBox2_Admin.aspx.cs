...
public partial class Modules_Boxes_Gallery_Gallery_Admin : RXServer.Lib.RXDefaultPage
{
            ...
            switch (RXServer.Web.RequestValues.Page)
            {
                ...
                case "AddImage":
                    if (!Page.IsPostBack)
                    {
                        ...
                        this.ltrHelpText.Text = RXMali.GetXMLHelpNode("GalleryBox2/Add");
                    }
                break;
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    this.ltrHelpText.Text = RXMali.GetXMLHelpNode("GalleryBox2/Edit");
    ...
    public void BindTextData()
    {
        ...
        try
        {
            this.ltrHelpText.Text = RXMali.GetXMLHelpNode("GalleryBox2/Text");
    ...
    public void BindListData()
    {
        ...
        try
        {
            this.ltrHelpText.Text = RXMali.GetXMLHelpNode("GalleryBox2/List");
            String list = "";
            ...
            if (total > 0)
            {
                ...
                foreach (RXServer.Modules.Base.List.Item item in cl)
                {
                    ...
                    list += "<td valign='middle'><table cellpadding='0' cellspacing='0'><tr><td><a href='GalleryBox2_Admin.aspx?Page=EditImage&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&amp;ViewId=" + item.Id.ToString() + "&amp;Var=" + RXServer.Web.RequestValues.Var + "'><img src='../../../App_Themes/WebAdmin/Images/icon_edit.gif' class='img_noborder' /></a></td><td><a href='GalleryBox2_Admin.aspx?Page=EditImage&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&amp;ViewId=" + item.Id.ToString() + "&amp;Var=" + RXServer.Web.RequestValues.Var + "'>&nbsp;Edit</a></td></tr></table></td>";
    ...
    public void BindMenuData()
    {
        ...
        try
        {
            ...
            {
                list += "<td><a href='GalleryBox2_Admin.aspx?Page=Gallery&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&amp;Var=" + RXServer.Web.RequestValues.Var + "' class='submenu_on'>Gallery</a></td>";
            }
            else
            {
                list += "<td><a href='GalleryBox2_Admin.aspx?Page=Gallery&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&amp;Var=" + RXServer.Web.RequestValues.Var + "' class='submenu_off'>Gallery</a></td>";
            }
            list += "<td style='width:20px;'></td>";
            if (RXServer.Web.RequestValues.Page == "Content")
            {
                list += "<td><a href='GalleryBox2_Admin.aspx?Page=Module&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&amp;Var=" + RXServer.Web.RequestValues.Var + "' class='submenu_on'>Content</a></td>";
            }
            else
            {
                list += "<td><a href='GalleryBox2_Admin.aspx?Page=Module&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&amp;Var=" + RXServer.Web.RequestValues.Var + "' class='submenu_off'>Content</a></td>";
            }
            list += "<td style='width:20px;'></td>";
    ...
    public void BindMenuData2()
    {
        ...
        try
        {
            ...
            {
                list += "<td><a href='GalleryBox2_Admin.aspx?Page=AddImage&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&amp;Var=" + RXServer.Web.RequestValues.Var + "'><img src='../../../App_Themes/WebAdmin/Images/icon_add.gif' class='img_noborder' /></a></td><td style='width:6px;'></td><td><a href='GalleryBox2_Admin.aspx?Page=AddImage&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&amp;Var=" + RXServer.Web.RequestValues.Var + "' class='submenu_on'>Add Image</a></td>";
            }
            else
            {
                list += "<td><a href='GalleryBox2_Admin.aspx?Page=AddImage&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&amp;Var=" + RXServer.Web.RequestValues.Var + "'><img src='../../../App_Themes/WebAdmin/Images/icon_add.gif' class='img_noborder' /></a></td><td style='width:6px;'></td><td><a href='GalleryBox2_Admin.aspx?Page=AddImage&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&amp;Var=" + RXServer.Web.RequestValues.Var + "' class='submenu_off'>Add Image</a></td>";
            }

...
public partial class Modules_Boxes_ContactBox2_ContactBox2_Admin : RXServer.Lib.RXDefaultPage
{
    String class_name = "Modules_Boxes_ContactBox2_ContactBox2_Admin";
    String ErrorList = "";
    ...
    public void BindTextData()
    {
        ...
        try
        {
            ...
            this.txtTitle.Text = Server.HtmlDecode(sm.Text2).Replace("`", "'");
            this.RadEditor1.Content = Server.HtmlDecode(sm.Text4).Replace("`", "'");
            this.RadEditor2.Content = Server.HtmlDecode(sm.Text6).Replace("`", "'");
            this.RadEditor3.Content = Server.HtmlDecode(sm.Text7.Replace("`", "'"));
            this.txtMailSubject.Text = Server.HtmlDecode(sm.Text8).Replace("`", "'");
            this.txtFromAdress.Text = Server.HtmlDecode(sm.Text9).Replace("`", "'");
    ...
    public void BindCategoryData(String eId)
    {
        ...
        try
        {
            ...
            this.txtCategoryName.Text = Server.HtmlDecode(e.Value25.Replace("`", "'"));
            this.txtCategoryEmail.Text = Server.HtmlDecode(e.Value26).Replace("`", "'");
        ...
        try
        {
            ...
            if (total > 0)
            {
                ...
                foreach (RXServer.Modules.Base.List.Item item in cl)
                {
                    ...
                    list += "<td valign='middle'><a href='ContactBox2_Admin.aspx?Page=AddCategory&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&amp;ViewId=" + item.Id.ToString() + "&Var=" + RXServer.Web.RequestValues.Var + "' class='underline'>" + item.Value25 + "</a></td>";
                    if (item.Value6 == "true")
                    {
                    ...
                    list += "<td valign='middle'><table cellpadding='0' cellspacing='0'><tr><td><a href='ContactBox2_Admin.aspx?Page=AddCategory&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&amp;ViewId=" + item.Id.ToString() + "&Var=" + RXServer.Web.RequestValues.Var + "'><img src='../../../App_Themes/WebAdmin/Images/icon_edit.gif' class='img_noborder' /></a></td><td><a href='ContactBox2_Admin.aspx?Page=AddCategory&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&amp;ViewId=" + item.Id.ToString() + "&Var=" + RXServer.Web.RequestValues.Var + "'>&nbsp;Edit</a></td></tr></table></td>";
    ...
    //                    list += "<tr style='background-color: #EFEFEF; vertical-align: middle;'  class='Text11_gray'>";
    //                }
    //                list += "<td valign='middle'><a href='ContactBox2_Admin.aspx?Page=AddSubCategory&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&amp;ViewId=" + item.Id.ToString() + "&Var=" + RXServer.Web.RequestValues.Var + "' class='underline'>" + item.Value25 + "</a></td>";
    //                if (item.Value6 == "true")
    //                {
    //                    list += "<td valign='middle' align='center'><img src='../../../App_Themes/WebAdmin/Images/icon_visible_on.gif' title='Active' class='img_noborder' /></td>";
    //                }
    ...
    //                list += "<td valign='middle' align='center'><a href='" + Request.Url.ToString() + "&Up=" + item.Id.ToString() + "'><img src='../../../App_Themes/WebAdmin/Images/icon_arrow_up.gif' alt='Move Up' class='img_noborder' /></a> / <a href='" + Request.Url.ToString() + "&Down=" + item.Id.ToString() + "'><img src='../../../App_Themes/WebAdmin/Images/icon_arrow_down.gif' alt='Move Down' class='img_noborder' /></a></td>";
    //                list += "<td valign='middle'><table cellpadding='0' cellspacing='0'><tr><td><a href='" + RXMali.GetLastUrl(Request.Url.ToString()) + "&DelId=" + item.Id.ToString() + "' onclick=\"return confirm('Are you sure you want to remove this item ( " + item.Value25 + " )?')\"><img src='../../../App_Themes/WebAdmin/Images/icon_bullet_delete.gif' class='img_noborder' /></a></td><td><a href='" + RXMali.GetLastUrl(Request.Url.ToString()) + "&DelId=" + item.Id.ToString() + "' onclick=\"return confirm('Are you sure you want to remove this item( " + item.Value25 + " )?')\">Delete</a></td></tr></table></td>";
    //                list += "<td valign='middle'><table cellpadding='0' cellspacing='0'><tr><td><a href='ContactBox2_Admin.aspx?Page=AddSubCategory&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&amp;ViewId=" + item.Id.ToString() + "&Var=" + RXServer.Web.RequestValues.Var + "'><img src='../../../App_Themes/WebAdmin/Images/icon_edit.gif' class='img_noborder' /></a></td><td><a href='ContactBox2_Admin.aspx?Page=AddSubCategory&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&amp;ViewId=" + item.Id.ToString() + "&Var=" + RXServer.Web.RequestValues.Var + "'>&nbsp;Edit</a></td></tr></table></td>";
        ...
        try
        {
            ...
            if (total > 0)
            {
                ...
                foreach (RXServer.Modules.Base.List.Item item in cl)
                {
                    ...
                    list += "<td valign='middle'><a href='ContactBox2_Admin.aspx?Page=AddClient&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&amp;ViewId=" + item.Id.ToString() + "&Var=" + RXServer.Web.RequestValues.Var + "' class='underline'>" + item.Value25 + "</a></td>";
                    if (item.Value6 == "true")
                    {
                        list += "<td valign='middle' align='center'><img src='../../../App_Themes/WebAdmin/Images/icon_visible_on.gif' title='Active' class='img_noborder' /></td>";
                    }
                    ...
                    list += "<td valign='middle' align='center'><a href='" + Request.Url.ToString() + "&Up=" + item.Id.ToString() + "'><img src='../../../App_Themes/WebAdmin/Images/icon_arrow_up.gif' alt='Move Up' class='img_noborder' /></a> / <a href='" + Request.Url.ToString() + "&Down=" + item.Id.ToString() + "'><img src='../../../App_Themes/WebAdmin/Images/icon_arrow_down.gif' alt='Move Down' class='img_noborder' /></a></td>";
                    list += "<td valign='middle'><table cellpadding='0' cellspacing='0'><tr><td><a href='" + RXMali.GetLastUrl(Request.Url.ToString()) + "&DelId=" + item.Id.ToString() + "' onclick=\"return confirm('Are you sure you want to remove this item ( " + item.Value25 + " )?')\"><img src='../../../App_Themes/WebAdmin/Images/icon_bullet_delete.gif' class='img_noborder' /></a></td><td><a href='" + RXMali.GetLastUrl(Request.Url.ToString()) + "&DelId=" + item.Id.ToString() + "' onclick=\"return confirm('Are you sure you want to remove this item( " + item.Value25 + " )?')\">Delete</a></td></tr></table></td>";
                    list += "<td valign='middle'><table cellpadding='0' cellspacing='0'><tr><td><a href='ContactBox2_Admin.aspx?Page=AddClient&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&amp;ViewId=" + item.Id.ToString() + "&Var=" + RXServer.Web.RequestValues.Var + "'><img src='../../../App_Themes/WebAdmin/Images/icon_edit.gif' class='img_noborder' /></a></td><td><a href='ContactBox2_Admin.aspx?Page=AddClient&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&amp;ViewId=" + item.Id.ToString() + "&Var=" + RXServer.Web.RequestValues.Var + "'>&nbsp;Edit</a></td></tr></table></td>";
    ...
    public void BindMenuData()
    {
        ...
        try
        {
            ...
            {
                list += "<td><a href='ContactBox2_Admin.aspx?Page=Content&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&Var=" + RXServer.Web.RequestValues.Var + "' class='submenu_on'>Content</a></td>";
            }
            else
            {
                list += "<td><a href='ContactBox2_Admin.aspx?Page=Content&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&Var=" + RXServer.Web.RequestValues.Var + "' class='submenu_off'>Content</a></td>";
            }
            list += "<td style='width:20px;'></td>";
            if (RXServer.Web.RequestValues.Page == "Category")
            {
                list += "<td><a href='ContactBox2_Admin.aspx?Page=Category&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&Var=" + RXServer.Web.RequestValues.Var + "' class='submenu_on'>Categories</a></td>";
            }
            else
            {
                list += "<td><a href='ContactBox2_Admin.aspx?Page=Category&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&Var=" + RXServer.Web.RequestValues.Var + "' class='submenu_off'>Categories</a></td>";
            }
            //list += "<td style='width:20px;'></td>";
            //if (RXServer.Web.RequestValues.Page == "Subcategory")
            //{
            //    list += "<td><a href='ContactBox2_Admin.aspx?Page=Subcategory&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&Var=" + RXServer.Web.RequestValues.Var + "' class='submenu_on'>Subcategories</a></td>";
            //}
            //else
            //{
            //    list += "<td><a href='ContactBox2_Admin.aspx?Page=Subcategory&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&Var=" + RXServer.Web.RequestValues.Var + "' class='submenu_off'>Subcategories</a></td>";
            //}
            list += "<td style='width:20px;'></td>";
            if (RXServer.Web.RequestValues.Page == "Clients")
            {
                list += "<td><a href='ContactBox2_Admin.aspx?Page=Clients&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&Var=" + RXServer.Web.RequestValues.Var + "' class='submenu_on'>Clients</a></td>";
            }
            else
            {
                list += "<td><a href='ContactBox2_Admin.aspx?Page=Clients&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&Var=" + RXServer.Web.RequestValues.Var + "' class='submenu_off'>Clients</a></td>";
            }
            list += "<td style='width:20px;'></td>";
    ...
    public void BindMenuData2()
    {
        ...
        try
        {
            ...
            if (RXServer.Web.RequestValues.Page == "Category" || RXServer.Web.RequestValues.Page == "AddCategory")
            {
                ...
                {
                    list += "<td><a href='ContactBox2_Admin.aspx?Page=AddCategory&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&Var=" + RXServer.Web.RequestValues.Var + "'><img src='../../../App_Themes/WebAdmin/Images/icon_add.gif' class='img_noborder' /></a></td><td style='width:6px;'></td><td><a href='ContactBox2_Admin.aspx?Page=AddCategory&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&Var=" + RXServer.Web.RequestValues.Var + "' class='submenu_on'>Add Category</a></td>";
                }
                else
                {
                    list += "<td><a href='ContactBox2_Admin.aspx?Page=AddCategory&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&Var=" + RXServer.Web.RequestValues.Var + "'><img src='../../../App_Themes/WebAdmin/Images/icon_add.gif' class='img_noborder' /></a></td><td style='width:6px;'></td><td><a href='ContactBox2_Admin.aspx?Page=AddCategory&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&Var=" + RXServer.Web.RequestValues.Var + "' class='submenu_off'>Add Category</a></td>";
                }
            ...
            //    {
            //        list += "<td><a href='ContactBox2_Admin.aspx?Page=AddSubCategory&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&Var=" + RXServer.Web.RequestValues.Var + "'><img src='../../../App_Themes/WebAdmin/Images/icon_add.gif' class='img_noborder' /></a></td><td style='width:6px;'></td><td><a href='ContactBox2_Admin.aspx?Page=AddSubCategory&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&Var=" + RXServer.Web.RequestValues.Var + "' class='submenu_on'>Add Subcategory</a></td>";
            //    }
            //    else
            //    {
            //        list += "<td><a href='ContactBox2_Admin.aspx?Page=AddSubCategory&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&Var=" + RXServer.Web.RequestValues.Var + "'><img src='../../../App_Themes/WebAdmin/Images/icon_add.gif' class='img_noborder' /></a></td><td style='width:6px;'></td><td><a href='ContactBox2_Admin.aspx?Page=AddSubCategory&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&Var=" + RXServer.Web.RequestValues.Var + "' class='submenu_off'>Add Subcategory</a></td>";
            //    }
            //    list += "<td style='width:20px; height:34px;'></td>";
            //    list += "</tr>";
            //    list += "</table>";
            ...
            if (RXServer.Web.RequestValues.Page == "Clients" || RXServer.Web.RequestValues.Page == "AddClient")
            {
                ...
                {
                    list += "<td><a href='ContactBox2_Admin.aspx?Page=AddClient&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&Var=" + RXServer.Web.RequestValues.Var + "'><img src='../../../App_Themes/WebAdmin/Images/icon_add.gif' class='img_noborder' /></a></td><td style='width:6px;'></td><td><a href='ContactBox2_Admin.aspx?Page=AddClient&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&Var=" + RXServer.Web.RequestValues.Var + "' class='submenu_on'>Add Client</a></td>";
                }
                else
                {
                    list += "<td><a href='ContactBox2_Admin.aspx?Page=AddClient&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&Var=" + RXServer.Web.RequestValues.Var + "'><img src='../../../App_Themes/WebAdmin/Images/icon_add.gif' class='img_noborder' /></a></td><td style='width:6px;'></td><td><a href='ContactBox2_Admin.aspx?Page=AddClient&SitId=" + RXServer.Web.RequestValues.SitId + "&PagId=" + RXServer.Web.RequestValues.PagId + "&ModId=" + RXServer.Web.RequestValues.ModId + "&Var=" + RXServer.Web.RequestValues.Var + "' class='submenu_off'>Add Client</a></td>";
                }
                list += "<td style='width:20px; height:34px;'></td>";
                list += "</tr>";
                list += "</table>";
    ...
    protected void btnSaveData_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            sm.Text2 = Server.HtmlEncode(this.txtTitle.Text).Replace("'", "`");
            sm.Text4 = Server.HtmlEncode(this.RadEditor1.Content).Replace("'", "`");
            sm.Text6 = Server.HtmlEncode(this.RadEditor2.Content).Replace("'", "`");
            sm.Text7 = Server.HtmlEncode(this.RadEditor3.Content).Replace("'", "`");
            sm.Text8 = Server.HtmlEncode(this.txtMailSubject.Text).Replace("'", "`");
            sm.Text9 = Server.HtmlEncode(this.txtFromAdress.Text).Replace("'", "`");
                ...
                if (valid)
                {
                    if (RXServer.Web.RequestValues.ViewId != "")   // EDIT Item
                    {
                        ...
                        if (obd_id > 0)
                        {
                            ...
                            i.Value25 = Server.HtmlEncode(this.txtCategoryName.Text).Replace("'", "`");
                            i.Value26 = Server.HtmlEncode(this.txtCategoryEmail.Text.Replace("'", "`"));
                ...
                if (valid)
                {
                    ...
                    if (RXServer.Web.RequestValues.ViewId != "")   // EDIT Item
                    {
                        ...
                        if (obd_id > 0)
                        {
                            ...
                            i.PagId = RXServer.Web.RequestValues.PagId;
                            i.ModId = RXServer.Web.RequestValues.ModId;
                            i.Value25 = Server.HtmlEncode(this.txtClientName.Text).Replace("'", "`");

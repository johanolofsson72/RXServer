...
public partial class Modules_Boxes_Cms_Cms_Admin : RXServer.Lib.RXDefaultPage
{
    String class_name = "Modules_Boxes_Cms_Cms_Admin";
    ...
    public void BindData()
    {
        ...
        try
        {
            RXServer.Modules.Crm tm = new RXServer.Modules.Crm(RXServer.Web.RequestValues.SitId, RXServer.Web.RequestValues.PagId, RXServer.Web.RequestValues.ModId);
    ...
    protected void btnSaveData_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            tm.Text3 = Server.HtmlEncode(this.RadEditor2.Content).Replace("'", "`");
